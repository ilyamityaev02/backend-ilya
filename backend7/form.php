...
<form id="form" method="POST" action="">
        <input type="hidden" name="<?= $token_id; ?>" value="<?= $token_value; ?>" />
          <label> <input type="text" placeholder="Имя" name="fio" <?php if ($errors['fio']) {print 'class="error"';} ?> value="<?php print htmlspecialchars($values['fio'], ENT_QUOTES, 'UTF-8'); ?>"/><br /></label>
          <label><input type="email" placeholder="Email" name="email" <?php if ($errors['email']) {print 'class="error"';} ?> value="<?php print htmlspecialchars($values['email'], ENT_QUOTES, 'UTF-8'); ?>"/><br /></label>
          ...
          ><br /><br/>
          <label> Биография<br/> <textarea name="about"<?php if ($errors['about']) {print 'class="error"';} ?>><?php print htmlspecialchars($values['about'], ENT_QUOTES, 'UTF-8'); ?></textarea></label><br />
