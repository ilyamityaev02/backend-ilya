...
<form id="form" method="POST" action="admin.php">
          ...
          <label>Имя: <input type="text" placeholder="Имя" name="fio" value="<?php print htmlspecialchars($values['fio'], ENT_QUOTES, 'UTF-8'); ?>"/><br /></label>
          <label>Почта: <input type="email" placeholder="Email" name="email" value="<?php print htmlspecialchars($values['email'], ENT_QUOTES, 'UTF-8'); ?>"/><br /></label>
          ...
          ><br />
          <label> Биография:<br/> <textarea name="about"><?php print htmlspecialchars($values['about'], ENT_QUOTES);?></textarea></label><br /><br>
