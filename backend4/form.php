...
<form id="form" method="POST" action="">
          ...
          ><br /><br/>
          <label> Биография<br/> <textarea name="about"><?php if ($errors['about']) {print 'class="error"';} ?> value="<?php print $values['fio']; ?></textarea></label><br />
          <label><input type="checkbox" name="check" value="Yes"/>С контрактом ознакомлен</label><br /><br/>
